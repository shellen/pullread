...
function showSettingsPage(scrollToSection) {
  ...
  html += '</div>';
  html += '<div class="settings-row" style="gap:12px"><span style="color:var(--muted);font-size:12px">\u00A9 A Little Drive LLC</span><a href="mailto:support@alittledrive.com" style="font-size:12px;color:var(--muted)">support@alittledrive.com</a></div>';
  html += '</div>';
