...
function showSettingsPage(scrollToSection) {
  ...
  html += '<a href="#" onclick="prOpenExternal(\'https://pullread.com/releases#v\' + (window._prCurrentVersion || \'0.4.4\'));return false" style="font-size:13px;color:var(--link)">What\'s New</a>';
